...
const sidebarItems = [
  ...
  },
  {
    title: "Tools",
    items: [
      { icon: Bot, label: "Prompt Builder", href: "#prompt-builder", active: true },
...
export default function PromptBuilder() {
  ...
  const handleNavigation = (href: string) => {
    window.location.hash = href.slice(1) // Remove the # for setting hash
  }
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
              ...
              <TabsContent value="prompt" className="space-y-6">
                <Card>
                  ...
                  <CardContent>
                    {generatedPrompt ? (
                      <pre className="whitespace-pre-wrap bg-gray-50 p-4 rounded-lg border text-sm overflow-auto max-h-96">
                        {generatedPrompt}
                      </pre>
                    ) : (
