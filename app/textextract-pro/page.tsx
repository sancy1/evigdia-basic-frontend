...
//       { icon: FileText, label: "TextExtract Pro", href: "#textextract-pro", active: true },
...
//                           <div className="space-y-2">
//                             <Label>Summary Length: {settings.summaryLength}%</Label>
//                             <Slider
//                               value={[settings.summaryLength]}
//                               onValueChange={(value) => setSettings((prev) => ({ ...prev, summaryLength: value[0] }))}
//                               max={100}
//                               min={10}
//                               step={10}
//                               className="w-full"
...
//                             Keyword Extraction
//                           </Label>
//                           <p className="text-sm text-gray-500">Extract important keywords and phrases</p>
//                         </div>
//                         <Switch
...
//                             Sentiment Analysis
//                           </Label>
//                           <p className="text-sm text-gray-500">Analyze emotional tone of the text</p>
//                         </div>
//                         <Switch
